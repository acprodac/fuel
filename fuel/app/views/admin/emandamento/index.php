        <h3><a class="btnCadastrarNovo btn btn-success btnLink" href="<?php echo Uri::create('admin/emandamento/cadastrar'); ?>">Cadastrar nova Obra</a>

        <?php if(!empty($itens) && count($itens) >= 2) : ?>
            <a href="<?php echo Uri::create('admin/emandamento/ordenar'); ?>" class="btn btn-primary btnOrdenar btnLink">Ordenar</a>
        <?php endif; ?>
    ...
    <div id="containner">
        <form id="formSave" class="well well-large form-page form-page-margin form-create" action="<?php echo Uri::current(); ?>" method="POST" accept-charset="utf-8">
            <div class="formInit">
                ...
                <div class="boxTinyMce">
                    <textarea name="descricao" id="descricao" class="form form-text input-xxlarge tinyMce tinyMce-min" data-height="150px"><?php echo $page->descricao; ?></textarea>
                </div>
        ...
        <form id="formBuscaEmpresas" class="well well-large form-page<?php echo !empty($termoBusca) ? ' result' : ''; ?>" action="<?php echo Uri::current(); ?>" method="GET" accept-charset="utf-8">
            ...
            <label for="empresa">Procurar Obras em andamento:</label>
            ...
            <?php if(!empty($termoBusca)) : ?>
                <a class="btn btn-link" href="<?php echo Uri::create('admin/emandamento'); ?>"><i class="icon-chevron-left"></i>Voltar</a>
            <?php endif; ?>
        ...
        <?php if(empty($itens)) : ?>
            ...
            <h4>Nenhuma obra em andamento <?php echo !empty($termoBusca) ? 'encontrado' : 'cadastrado'; ?>.</h4>
        ...
        <?php else : ?>
            ...
            <table class="table table-hover tbl-andamento">
                <thead>
                    <tr>
