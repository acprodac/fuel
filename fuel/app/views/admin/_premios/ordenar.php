	<h3>
		<a class="btnCadastrarNovo btn btn-success btnLink" href="<?php echo Uri::create('admin/pedreiras/cadastrar'); ?>">Cadastrar nova pedreira</a>
		Pedreiras <span>&gt; Ordenar</span></h3>
    <?php echo $boxFeedback; ?>
    
    <div id="containner">
    	<a href="<?php echo Uri::create('admin/pedreiras'); ?>" class="btnLink" class="btnLink"><i class="icon-chevron-left"></i>Voltar</a>
        ...
        <?php else : ?>
            ...
            <form id="formSave" class="well well-large form-page formVitrineOrdenar" action="<?php echo Uri::current(); ?>" method="POST" accept-charset="utf-8" data-redirect="<?php echo Uri::create('admin/pedreiras'); ?>">
