<form id="formSave" class="well well-large form-page form-page-margin" action="<?php echo Uri::current(); ?>" method="POST" accept-charset="utf-8" data-redirect="<?php echo Uri::create('admin/premios'); ?>">
    <div class="formInit">
        ...
        <div class="boxTinyMce">
            <textarea name="texto" id="texto" class="form form-text input-xxlarge required tinyMce" data-height="300px"><?php echo !isset($formCreate) ? stripslashes($item->texto) : ''; ?></textarea>
        </div>
        ...
        <div class="box-item-galeria">
            ...
            <div class="box-editar <?php echo !isset($item->galeria->id) ? 'hide' : ''; ?>">
                <a data-fancybox-type="iframe" href="<?php echo Uri::create('admin/galeria/editar/' . (isset($item->galeria->id) ? $item->galeria->id : '{ID}') . '?_c=frame'); ?>" class="btn btn-galeria-edit btn-info">Editar galeria <span><?php echo isset($item->galeria->id) ? $item->galeria->titulo : ''; ?></span></a>
