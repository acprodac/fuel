...
switch(PROJ_MOD){
    case 'dev':
        ...
        $upload_dir = '/embu/www/upload/tinyMce/';
        $current_path = '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'upload' . DIRECTORY_SEPARATOR . 'tinyMce/';
        break;
    case 'homolog':
        $base_url="http://studiowox.com.br";
        $upload_dir = '/clientes/tboom/embu/www/upload/tinyMce/';
        $current_path = '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'upload' . DIRECTORY_SEPARATOR . 'tinyMce/';
        break;
    case 'staging':
        $base_url="";
        $upload_dir = '/_homolog/upload/tinyMce/';
        $current_path = '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'upload' . DIRECTORY_SEPARATOR . 'tinyMce/';
        break;
    case 'prod':
        $base_url="";
        $upload_dir = '/upload/tinyMce/';
        $current_path = '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'upload' . DIRECTORY_SEPARATOR . 'tinyMce/';
}
